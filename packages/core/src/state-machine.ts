...
const TRANSITIONS = new Map<LeadState | null, ReadonlySet<LeadState>>([
    ...
    ["APPROVED", new Set(["SENT", "REJECTED", "BOUNCED", "UNSUBSCRIBED"])],
    ["SENT", new Set(["REPLIED", "NO_REPLY", "BOUNCED", "UNSUBSCRIBED", "REJECTED"])],
    ["NO_REPLY", new Set(["FOLLOWUP_1", "REPLIED", "REJECTED", "BOUNCED", "UNSUBSCRIBED"])],
    [
        "FOLLOWUP_1",
        new Set(["FOLLOWUP_2", "REPLIED", "REJECTED", "BOUNCED", "UNSUBSCRIBED"]),
    ],
    ["FOLLOWUP_2", new Set(["NURTURE", "REPLIED", "REJECTED", "BOUNCED", "UNSUBSCRIBED"])],
    ["NURTURE", new Set(["REPLIED", "REJECTED", "BOUNCED", "UNSUBSCRIBED"])],
