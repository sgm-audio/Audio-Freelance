...
export default function AudioVisInner() {
  return (
    <div className="h-48 rounded-lg overflow-hidden bg-card border border-border">
      <Suspense fallback={<div className="w-full h-full flex items-center justify-center text-sm text-muted-foreground">Loading...</div>}>
